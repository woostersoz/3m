...
class FbAdInsight(Document):
    ...
    meta = {'collection': 'facebookAdInsight', 'indexes': ['company_id', 'source_source', 'updated_date', 'source_created_date', 'source_account_id', 'source_campaign_id'], 'ordering':['-updated_date']}
