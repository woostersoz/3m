...
class Lead(Document):
    ...
    meta = {'collection': 'lead', 'indexes': ['company_id', {'fields' : ('source_first_name', 'source_last_name'), 'unique': False}, {'fields' : ('company_id', 'hspt_id'), 'unique': False}, {'fields' : ('company_id', 'leads.sfdc.Id'), 'unique': False}, {'fields' : ('company_id', 'sfdc_contact_id'), 'unique': False}, {'fields' : ('company_id', 'source_source'), 'unique': False}, {'fields' : ('company_id', 'source_stage'), 'unique': False}, {'fields' : ('company_id', 'source_company'), 'unique': False},  {'fields' : ('company_id', 'leads.hspt.properties.hs_analytics_source', 'leads.hspt.properties.hs_analytics_source_data_1', 'leads.hspt.properties.hs_analytics_first_visit_timestamp'), 'unique': False, 'name': 'new_visit_index'}, {'fields' : ('company_id', 'leads.hspt.properties.hs_analytics_source', 'leads.hspt.properties.hs_analytics_first_visit_timestamp', 'leads.hspt.versions.hs_analytics_last_referrer.value', 'leads.hspt.versions.hs_analytics_last_referrer.timestamp'), 'unique': False, 'name': 'repeat_visit_index'}, 'updated_date', 'leads.hspt.properties.hs_analytics_source_data_1', 'leads.hspt.properties.hs_analytics_source_data_2', 'leads.hspt.properties.hs_analytics_first_visit_timestamp', 'leads.hspt.versions.hs_analytics_last_referrer.value', 'leads.hspt.versions.hs_analytics_last_referrer.timestamp'], 'ordering':['-updated_date']}
