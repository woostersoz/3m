...
urlpatterns = patterns('',
    ...
    url(r'rooms/user/slack/messages/', views.getUserSlackMessages, name="user_slack_messages"),
    url(r'room/user/slack/message/create/', views.user_create_slack_message, name="user_create_slack_message"),
    url(r'rooms/user/slack/', views.getUserSlackMembership, name="user_slack_channels_and_groups"),
